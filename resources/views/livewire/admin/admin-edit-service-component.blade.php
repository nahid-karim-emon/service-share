                        ...
                        <div class="col-md-8 col-md-offset-2 profile1">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="add-service-categorie-title">Edit Service</p>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @error('newthumbnail') <p class="text-denger">{{$message}}</p> @enderror
                                                @if($newthumbnail)
                                        ...
                                        <button tupe="submit" class="add-new-btn pull-right">Update Service</button>
                                    </form>
                                </div>
                            </div>
                        </div>
