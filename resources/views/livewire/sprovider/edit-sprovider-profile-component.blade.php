                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            @endif
                                            <form class="form-hprizontal " wire:submit.prevent="updateProfile">
                                                <div class="form-group">
                                                    <label for="newimage" class="control-label col-md-3">Profile Image: </label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="form-control-files" name="newimage" wire:model="newimage" />
                                                        @if($newimage)
                                                ...
                                                <button type="submit" class="update-form-btn pull-right">Update Profile</button>
                                            </form>
                                        </div> 
                                    </div>
                                </div>
