...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $req)
    {

        # Here you have to receive all the order data to initate the payment.
        # Lets your oder trnsaction informations are saving in a table called "orders"
        # In orders table order uniq identity is "transaction_id","status" field contain status of the transaction, "amount" is the order amount to be paid and "currency" is for storing Site Currency which will be checked with paid currency.
        $re = json_decode($req->cart_json);
        ...
        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $re->cus_name;
        $post_data['cus_email'] = $re->cus_email;
        $post_data['cus_add1'] = $re->cus_addr1;
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $re->cus_phone;
        $post_data['cus_fax'] = "";
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->status == 'Pending') {
            ...
            return view('payment', compact('tran_id', 'amount', 'currency'))->with('success', "Transaction is successfully Completed");
